var cacheFactory = {
	...
	createForCallback: function() {
		var args = [].slice.apply(arguments, []);
		args.unshift({ type: 'callback' });
		return cacheFactory._create.apply(this, args);
	},
	
	createForPromisse: function() {
		var args = [].slice.apply(arguments, []);
		args.unshift({ type: 'promise' });
		return cacheFactory._create.apply(this, args);
	},
	
	create: function() {
		// For backward compatibility
		return cacheFactory.createForCallback.apply(this, arguments);
	},
...
if (typeof exports != 'undefined') {
	...
	exports.createForCallback = cacheFactory.createForCallback;
	exports.createForPromisse = cacheFactory.createForPromisse;
